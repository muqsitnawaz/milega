            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="footer-address">
                        <ul style="list-style-type: none;">
                            ...
                            <li class="footer-contact"><i class="fa fa-phone"></i>+92 (123) 456-7890</li>
                        </ul>
                    </div>
                </div><!--/.col-md-3 -->
                ...
                <div class="col-md-4">
                    ...
                    <div class="subscription">
                        <p>Sign up for our newsletter and get all the latest updates. Don't worry,
                        we don't spam.</p>
                        <div class="form-group">
    ...
    <div id="copyright-section" class="copyright-section">
        <div class="container">
            <div class="row">
                <div class="col-md-7">
                    <div class="copyright">
                        Copyright © 2016. All Rights Reserved. Designed and Developed by Muqsit N.</a>
                    </div>
                </div>
            </div><!--/.row -->
        </div><!-- /.container -->
